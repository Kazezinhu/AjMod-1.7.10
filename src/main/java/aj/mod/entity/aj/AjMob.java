...
public class AjMob extends EntityAgeable{

	public AjMob(World parlWorld) {
		super(parlWorld);
		...
		this.tasks.addTask(3, new EntityAITempt(this, 1.2D, Items.cookie, false));
